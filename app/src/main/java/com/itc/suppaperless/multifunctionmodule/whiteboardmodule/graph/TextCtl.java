package com.itc.suppaperless.multifunctionmodule.whiteboardmodule.graph;
...
import com.itc.suppaperless.multifunctionmodule.whiteboardmodule.listener.ASketchpadDraw;
...
public class TextCtl extends ASketchpadDraw {
    ...
    private void newEditView(int x, int y) {
        ...
        WhiteBoardUtil.showSoftInput(context);
